...
## 2024-05-16 - Add index on url to articles
**Learning:** The FetchNewsCommand regularly checks if an article exists by looking up its URL, performing a full table scan without an index.
**Action:** Always verify fields used in updateOrCreate conditions are indexed, especially on large or frequently updated tables.
