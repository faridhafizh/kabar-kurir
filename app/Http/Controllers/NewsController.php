...
class NewsController extends Controller
{
    ...
    {
        // ⚡ Bolt Optimization: Cache the individual article response for 1 hour.
        // Reading single articles is a common operation and their content rarely changes,
        // so caching reduces database load.
