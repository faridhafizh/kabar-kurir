...
class TrackingController extends Controller
{
    public function track(Request $request)
    {
        ...
        // ⚡ Bolt Optimization: Implement negative caching explicitly instead of using Cache::remember.
        // Cache::remember doesn't cache when an Exception is thrown inside the closure,
        // which leaves the system vulnerable to rate-limit exhaustion from repeated invalid requests (like 'not found').
